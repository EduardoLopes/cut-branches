...
import * as getValidatedLocalStorageModule from '$utils/get-validated-local-storage';
import * as setValidatedLocalStorageModule from '$utils/set-validated-local-storage';

// Mock storage modules
vi.mock('$utils/get-validated-local-storage', () => ({
	getValidatedLocalStorage: vi.fn()
}));

vi.mock('$utils/set-validated-local-storage', () => ({
